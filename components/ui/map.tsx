                  ...
                  >
                    ...
                    >
                      <div className="flex items-center justify-center h-full">
                        <span className="text-sm font-medium px-3 py-1.5 rounded-md bg-black/80 text-white border border-accent/30 shadow-lg backdrop-blur-md whitespace-nowrap">
                          {dot.start.label}
                        </span>
                      </div>
                    </foreignObject>
      ...
      <AnimatePresence>
        {hoveredLocation && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: 10 }}
            className="absolute bottom-4 left-4 bg-black/80 text-white px-3 py-2 rounded-lg text-sm font-medium backdrop-blur-md sm:hidden border border-accent/30 shadow-lg"
          >
            {hoveredLocation}
          </motion.div>
        )}
